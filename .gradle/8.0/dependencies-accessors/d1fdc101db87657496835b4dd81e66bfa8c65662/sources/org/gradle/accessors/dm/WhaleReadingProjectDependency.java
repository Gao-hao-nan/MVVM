...
public class WhaleReadingProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":CapturePacketModule"
     */
    public CapturePacketModuleProjectDependency getCapturePacketModule() { return new CapturePacketModuleProjectDependency(getFactory(), create(":CapturePacketModule")); }
